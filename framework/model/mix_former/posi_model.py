...
from framework.model.mix_former.hidden_mix.rand_replace_zero import RandReplaceZeroMix
from framework.model.mix_former.hidden_mix.rand_gaoss_mix import BalancedRandGaossMix, HardRandGaossMix, SoftRandGaossMix
from framework.model.mix_former.hidden_mix.content_replace_mix import RandContentReplaceMix
...
class BertM3AEVQAModel(nn.Module):
    def __init__(self, img_size=224, patch_size=16, in_chans=3,
                 ...
                 norm_layer=nn.LayerNorm, select_hidden_mix="hard_rand_gauss_mix"):
        super().__init__()
...
if __name__ == '__main__':
    ...
    res = model(a, b, "train")
    t2 = time.time()
    print(t2 - t1)  # rand_content 0.38318    rand_zero 0.38745      rand_gauss 0.42673
