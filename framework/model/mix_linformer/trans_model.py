...
from framework.model.mix_linformer.hidden_mix.trans_mix import BalancedTransMix, SoftTransMix, HardTransMix
...
class BertM3AEVQAModel(nn.Module):
    def __init__(self, img_size=224, patch_size=16, in_chans=3,
                 ...
                 select_hidden_mix="hard_trans_mix"):
        super().__init__()
...
def trans_lin_former_small(**kwargs):
...
def trans_lin_former_base(**kwargs):
    model = BertM3AEVQAModel(
...
def trans_lin_former_large(**kwargs):
    model = BertM3AEVQAModel(
...
def trans_lin_former_huge(**kwargs):
    model = BertM3AEVQAModel(
