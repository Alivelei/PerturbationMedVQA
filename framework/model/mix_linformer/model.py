...
def general_lin_former_small(**kwargs):
...
def general_lin_former_base(**kwargs):
    model = BertM3AEVQAModel(
...
def general_lin_former_large(**kwargs):
    model = BertM3AEVQAModel(
...
def general_lin_former_huge(**kwargs):
    model = BertM3AEVQAModel(
...
if __name__ == '__main__':
    ...
    res = model(a, b)
    print(res.shape)
    print(sum(x.numel() for x in model.parameters()))  # 78023595
