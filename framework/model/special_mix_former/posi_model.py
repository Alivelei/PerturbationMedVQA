...
from framework.model.special_mix_former.hidden_mix.rand_replace_zero import RandReplaceZeroMix
from framework.model.special_mix_former.hidden_mix.rand_gaoss_mix import BalancedRandGaossMix, HardRandGaossMix, SoftRandGaossMix
from framework.model.special_mix_former.hidden_mix.content_replace_mix import RandContentReplaceMix
...
class BertM3AEVQAModel(nn.Module):
    def __init__(self, img_size=224, patch_size=16, in_chans=3,
                 ...
                 norm_layer=nn.LayerNorm, select_hidden_mix="rand_content_replace_mix",
                 select_layer_mix=None, random_layer_mix=0.25):
        super().__init__()
...
def special_posi_former_small(**kwargs):
...
def special_posi_former_base(**kwargs):
    model = BertM3AEVQAModel(
...
def special_posi_former_large(**kwargs):
    model = BertM3AEVQAModel(
...
def special_posi_former_huge(**kwargs):
    model = BertM3AEVQAModel(
