...
if __name__ == '__main__':
    ...
    parser.add_argument("--mix_flag", default="posi_mix", choices=["trans_mix", "posi_mix", "special_trans_mix", "special_posi_mix", None], help="mixup Flag.")
    ...
    parser.add_argument("--train_data_aug", default=True, choices=[True, False])
